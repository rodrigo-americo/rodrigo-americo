...
**Backend Developer** focado em construir sistemas que escalam, performam e não caem em produção.

Trabalho principalmente com **Python** e **C/C++** — o que significa que sei tanto estruturar uma API robusta quanto entender o que acontece "perto do metal" quando o desempenho importa.
...
| [webserv](https://github.com/rodrigo-americo/webserv) | Servidor HTTP construído do zero em C++: parsing de configuração, arquitetura orientada a eventos e design de sistema escalável. | `C++` |
